                      ...
                      : Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              FilledButton(
                                onPressed: () => context.read<AppState>().loadStats(),
                  ...
                  child: ListView(
                    ...
                    children: [
                      Wrap(
                        ...
                        runSpacing: 12,
                        children: [
                          _SummaryCard(label: 'Total Images', value: '${stats.totalImages}'),
                          _SummaryCard(label: 'Valid Images', value: '${stats.validImages}'),
                          _SummaryCard(label: 'Corrupt Images', value: '${stats.corruptImages}'),
                          _SummaryCard(label: 'Artifact Ready', value: stats.artifactReady ? 'Yes' : 'No'),
                        ],
                      ),
                      ...
                      _DistributionCard(
                        title: stats.hasLabels ? 'Inferred Labels' : 'Inferred Labels (not available yet)',
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 12),
                              _NumericLine(label: 'Width Mean', summary: stats.width),
                              _NumericLine(label: 'Height Mean', summary: stats.height),
                              _NumericLine(label: 'Aspect Mean', summary: stats.aspectRatio),
                              const SizedBox(height: 16),
                              Text('Exact duplicate groups: ${stats.exactDuplicateGroups}'),
                              Text('Near-duplicate groups: ${stats.nearDuplicateGroups}'),
                            ],
                          ),
                        ),
                      ),
